...
$$
\begin{aligned}
 E[Y|1,a+1] - E[Y|1,a] = &\beta_0 + \beta_M 1 + \blue{\beta_A}(a+1) + \red{\beta_{AM}}1(a+1)\\
  &- (\beta_0 + \beta_M 1 + \blue{\beta_A}(a) + \red{\beta_{AM}}1(a))\\
 = &\blue{\beta_A} + \red{\beta_{AM}}
 \end{aligned}
$$
...
$$
\begin{aligned}
 E[Y|0,a+1] - E[Y|0,a] = &\beta_0 + \beta_M0 + \blue{\beta_A}(a+1) + \red{\beta_{AM}}0(a+1) \\
 &- (\beta_0 + \beta_M 0 + \blue{\beta_A}(a) + \red{\beta_{AM}}0(a))\\

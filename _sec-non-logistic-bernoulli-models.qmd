...
If you want risk ratios, you can extract them from logistic regression models, 
...
to compute the risks, 
and then take the ratios of the risks. 
...
then you can extract risk ratios by exponentiating coefficients

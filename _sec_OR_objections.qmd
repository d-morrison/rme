...
In other words, for a model with an identify link function,
...
What is the expression for $\deriv{x} \Ef{Y|X=x}$ for the model above, 
if $X$ and $C$ are not independent?

...
the odd ratio is not very closely correlated with the risk difference, 
and risk difference is typically the metric that matters for policy decisions.

Another objection is that odds ratios depend on the set of covariates
in a model,

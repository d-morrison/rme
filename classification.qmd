...
The probability that the test is positive given that the person has the disease, denoted $\P(\text{positive} \mid \text{disease})$.
...
The probability that the test is negative given that the person does not have the disease, denoted $\P(\text{negative} \mid \text{no disease})$.
...
The probability that a person has the disease given that their test is positive, denoted $\P(\text{disease} \mid \text{positive})$.
...
The probability that a person does not have the disease given that their test is negative, denoted $\P(\text{no disease} \mid \text{negative})$.
...
$$
\P(D \mid +) = \frac{\P(+ \mid D) \cd \P(D)}{\P(+)}
$$

To find $\P(+)$, we use the **law of total probability**:

$$
\P(+) = \P(+ \mid D) \cd \P(D) + \P(+ \mid \neg D) \cd \P(\neg D)
$$
...
$$
\P(+ \mid D) \cd \P(D) = 0.99 \times 0.07 = 0.0693
$$
...
$$
\P(D \mid +) = \frac{0.0693}{0.0786} = 0.88
$$
...
\begin{aligned}
\P(D \mid +) &= \frac{\P(+ \mid D) \cd \P(D)}{\P(+)} \\
&= \frac{\P(+ \mid D) \cd \P(D)}{\P(+ \mid D) \cd \P(D) + \P(+ \mid \neg D) \cd \P(\neg D)} \\
&= \frac{\P(D)}{\P(D) + \frac{\P(+ \mid \neg D)}{\P(+ \mid D)} \cd \P(\neg D)} \\
&= \frac{1}{1 + \frac{\P(+ \mid \neg D)}{\P(+ \mid D)} \cd \frac{\P(\neg D)}{\P(D)}} \\
...
Notice how the prevalence ratio $\P(\neg D)/\P(D)$ appears explicitly in the denominator.

...
{{< include _subfiles/sec/_sec_pois-reg_intro.qmd >}}

# Interpreting Poisson regression models {.smaller}

{{< include _subfiles/sec/_sec_poisson_RRs.qmd >}}
...
{{< include _subfiles/sec/_sec_poisson_inference.qmd >}}

# Prediction

{{< include _subfiles/sec/_sec_pois-reg-preds.qmd >}}

# Diagnostics

{{< include _subfiles/sec/_sec_poisson_dx.qmd >}}

---

{{< include _subfiles/exm/_exm-needle-sharing-dx.qmd >}}

# Zero-inflation
{{< include _subfiles/sec/_sec_zero-inflation.qmd >}}

# Over-dispersion

{{< include _subfiles/sec/_sec-overdispersion.qmd >}}
---

{{< include _subfiles/misc/_note_glm-naming.qmd >}}

...
\ba
1 + \oddsf{\probs}
&= 1 + \frac{\probs}{1 - \probs}
\\
&= \frac{(1 - \probs) + \probs}{1 - \probs}
\\
&= \frac{1}{1 - \probs}
\\
&= {1/(1 - \probs)}
...
$$
\ba
1 - \invoddsf{\odds} &= 1 - \frac{\odds}{1 + \odds}
...
::: notes
This result is essentially the same as @lem-one-plus-odds.
:::

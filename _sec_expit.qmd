...
The **expit function** of a log-odds $\logodds$, also known as the **inverse-logit function** or **logistic function**, is the inverse-odds of the exponential of $\logodds$:
...
Apply @thm-odds-from-logodds and @def-expit.
:::

...
$$Y_i = \beta_0 + \beta_1 x_i + \varepsilon_i, \qquad \varepsilon_i \overset{\text{iid}}{\sim} \ndist{0, \sigma^2}$$
...
The parameters $\beta_0$ and $\beta_1$ are estimated
...
$\hat\beta_1 = `r round(coef(slr_fit)[["BMI"]], 2)`$ mg/dL per kg/m²,

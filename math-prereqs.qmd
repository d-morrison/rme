...
This chain rule is like the univariate chain rule, but the order matters now.
...
would be the 
[transpose](https://en.wikipedia.org/wiki/Gradient#Relationship_with_total_derivative)
of the gradient.

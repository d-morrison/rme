...
::: proof
Left to readers for now; use law of total probability and algebra.
:::
...
The odds function, $\oddsf(\pi)$, is defined as:

$$\oddsf{\pi} \eqdef \frac{\pi}{1-\pi}$$ {#eq-odds-probs}
...
:::{#thm-prob-to-odds}
If the probability of an outcome $A$ is $\Pr(A)=\pi(A)$,
...
:::: notes
Use @lem-p-neg0 and @lem-one-minus-odds-inv:
::::
...
Combining @lem-inverse-odds-nonevent2 and @lem-deriv-invodds:

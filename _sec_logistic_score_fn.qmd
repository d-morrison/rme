...
For a single-predictor model such as the `beetles` model,
...
where $c_i$ is the gas concentration for the beetle in observation $i$, 
and $\vec{c} = (c_1, c_2, ...c_n)$.
...
2. the weighted sum of the error times the covariate (in this case, the gas concentrations) equals 0:

...
We can apply the vector chain rule (@thm-chain-vec) here:
...
along with @thm-d_pi-d_eta and @lem-d_eta_d_vb:
...
\ba
\purple{\derivf{\pi}{\vb}} 
&= \red{\derivf{\eta}{\vb}} \blue{\derivf{\prob}{\logodds}} 
\\
&= \paren{\red{\vx}} \paren{\blue{\pi (1-\pi)}}
\\
&= \purple{\vx \pi (1-\pi)}
\ea
$$

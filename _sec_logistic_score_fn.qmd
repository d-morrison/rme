...
Let's first combine $\green{\derivf{\omega}{\eta}} \blue{\derivf{\pi}{\omega}} = \orange{\derivf{\pi}{\eta}}$ to get two more lemmas:
...
Combining @lem-d_pi_d_beta, @lem-d_eta_d_vb, and @lem-d_pi-d_eta:
...
Finally, 
combining @lem-score-logistic and @cor-logistic-score-comp, 
we have:

...
```
The sample size needed to achieve a standard error of 0.1 percentage point is $`r se0.1`$.
...
To achieve 80% power, the sample size must be at least $`r size.needed[1]`$.
To achieve 90% power, the sample size must be at least $`r size.needed[2]`$.
To achieve 95% power, the sample size must be at least $`r size.needed[3]`$.
To achieve 99% power, the sample size must be at least $`r size.needed[4]`$.

...
Overall, the simulated results for mean and standard error were very close to the expected theoretical values with bias on the order of $10^{-4}$ which is very small. This small bias suggests asymptotic consistency of the MLE.

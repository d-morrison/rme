...
```{r}
se0_1 <- sample_size(0.001)
```
The sample size needed to achieve a standard error of 0.1 percentage point is $`r se0_1`$.
...
binom.MLE.sim <- function(pi = 0.7, null = 0.5, n = 100, sim = 1000,
                          alpha = 0.05) {
...
sim10_3 <- binom.MLE.sim(
  pi = 0.7, null = 0.5, n = 10^3, sim = 1000, alpha = 0.05
)
sim10_3 |> summarize_sim() |> pander()
```

```{r}
sim10_5 <- binom.MLE.sim(
  pi = 0.7, null = 0.5, n = 10^5, sim = 1000, alpha = 0.05
)

sim10_5 |> summarize_sim() |> pander()
```
...
```{r}
sim10_3_05 <- binom.MLE.sim(
  pi = 0.5, null = 0.5, n = 10^3, sim = 1000, alpha = 0.05
)
sim10_3_05 |> summarize_sim() |> pander()
```

```{r}
sim10_5_05 <- binom.MLE.sim(
  pi = 0.5, null = 0.5, n = 10^5, sim = 1000, alpha = 0.05
)
sim10_5_05 |> summarize_sim() |> pander()
```

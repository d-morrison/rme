...
Descriptive questions don't need to even involve covariates
that we **could** intervene on;
they just need to be covariates that we can observe^[or else things will be more complicated, but we can sometimes still do it].

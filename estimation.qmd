...
## Relationship between residuals and errors
...
"Standard error" is a confusing concept in a few ways. First of all, it isn't even defined as a characteristic of the [estimation error](#def-estimation-error), $\erf{\hth}$! Moreover, it is just a synonym for standard deviation, so it seems like a redundant concept. However, standard errors help us construct p-values and confidence intervals, so they come up a lot - often enough to give them their own name.

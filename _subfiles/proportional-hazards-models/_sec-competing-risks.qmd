...
# Robustly extract CIF by cause code
# cuminc() names elements "group cause" (e.g., "1 1", "1 2");
# use endsWith() to find the right element regardless of group label
cif_names <- names(mros_cif)[names(mros_cif) != "Tests"]
fracture_name <- cif_names[endsWith(cif_names, " 1")]
death_name    <- cif_names[endsWith(cif_names, " 2")]

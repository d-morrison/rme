...
and omitted predictors that leave the mean model correct
cause overdispersion.
An omitted predictor correlated with the included ones is a different
problem --- it misspecifies the mean, so @def-overdispersion does not
apply to it at all.

...
and omitted predictors cause overdispersion.
An omitted predictor can additionally misspecify the mean,
and where it does, @def-overdispersion no longer applies:
the model is failing the hypothesis the definition assumes,
rather than being overdispersed.

...
Let $\pi = \P(Z=1|X=x)$ and $\mu = \Expp[Y|Z=0,X=x,T=t]$.
...
Derive the expected value and variance of $Y$, conditional on $X$ and $T$, as functions of $\pi = P(Z=1|X=x,T=t)$ and $\mu_0 = \Expp[Y|Z=0,X=x,T=t]$.
:::
...
Since $(1-\pi)\mu_0\bigl(1+\pi\mu_0\bigr) \geq (1-\pi)\mu_0 = \Expp[Y|X,T]$ for any $\pi > 0$,

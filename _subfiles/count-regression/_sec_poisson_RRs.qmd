...
$$
\begin{aligned}
&\phantom{={}} \log{\Expp[Y |{\color{red}{X_j = a}}, \vX_{-j}=\vx_{-j},T=t]} \\
&\phantom{={}} -\log{\Expp[Y |{\color{red}{X_j = b}}, \vX_{-j}=\vx_{-j},T=t]} \\
&= \log{t} + \beta_0 + \beta_1 x_1 + \ldots + {\color{red}{\beta_j (a)}} + \ldots + \beta_p x_p \\
&\phantom{={}} -\log{t} - \beta_0 - \beta_1 x_1 - \ldots - {\color{red}{\beta_j (b)}} - \ldots - \beta_p x_p \\

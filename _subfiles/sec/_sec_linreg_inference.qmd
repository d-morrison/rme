...
{{< include _subfiles/sec/_sec_linreg_coef_sampling_dist.qmd >}}

---

### Estimated covariance matrix and standard errors

{{< include _subfiles/sec/_sec_bw_vcov.qmd >}}

### Wald tests and confidence intervals

{{< include _subfiles/sec/_sec_linreg_wald.qmd >}}

## Inference for predicted means

{{< include _subfiles/sec/_sec_linreg_pred_inference.qmd >}}

## Inference for differences in means

{{< include _subfiles/sec/_sec_linreg_diff_means_inference.qmd >}}

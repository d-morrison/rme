...
::: notes
The simplified likelihood formulation is incomplete because it omits the censoring mechanism. We also observed whether or not the
...
::: notes
Specifically, if the event occurred at time $y$ (i.e., if $d=1$), then the

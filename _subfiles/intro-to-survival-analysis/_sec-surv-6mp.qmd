...
This dataset originates from a clinical trial in 1963 for 6-MP treatment vs. placebo for
acute leukemia in 42 children [@freireich1963effect].
...
$$\hat\haz = \frac{\sumin D_i}{\sumin Y_i}$$

::: notes
-   For the placebo group, the estimated hazard is just the reciprocal of the mean time:
:::
$$
\ba
\hat \haz_{\text{placebo}}
...
-   For the 6-MP group, $\hat\haz = 9/359 = 0.025$

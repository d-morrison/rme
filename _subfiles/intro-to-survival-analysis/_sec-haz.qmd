...
P(T=t|T \ge t)
&= \frac{f(t)}{\surv(t)}\\
&= \frac{\1{t \ge 0}\cdot \lambda  \ef{-\lambda t}}{\ef{-\lambda t}}\\
&=\1{t \ge 0}\cdot \lambda
\ea
$$
...
The **conditional survival probability** at time $t$,
denoted $\kappa(t)$, is the probability of surviving past $t$
given survival up to $t$:

$$\kappa(t) \eqdef \p(T > t \mid T \ge t)$$
...
#### Conditional survival is the complement of the hazard
...
Since $\{T < t\}$ and $\{T \ge t\}$ are mutually exclusive,
$\p(T < t \mid T \ge t) = 0$, so

$$
\ba
\kappa(t)
&= \p(T > t \mid T \ge t) \\
&= 1 - \p(T \le t \mid T \ge t) \\
&= 1 - \p(T = t \mid T \ge t) \\
&= 1 - \haz(t)
\ea
$$

...
&= \expf{-\sum_{t_i < t}\frac{d_i}{r_i}}\\
&= \prod_{t_i < t}\expf{-\frac{d_i}{r_i}}\\
&= \prod_{t_i < t}\hat{\kappa}_i
\ea
$$

where $\hat{\kappa}_i = \expf{-\hat{\haz}_i} = \expf{-d_i/r_i}$
is the Nelson-Aalen conditional survival factor
(compare with the KM factor $\hat{\kappa}_i = 1 - d_i/r_i$).
...
$$
\ba
\hat{\cuhaz}_{KM}(t) &= -\sum_{t_i < t}\logf{1-\frac{d_i}{r_i}}\\
\hsurv_{KM}(t) &= \prod_{t_i < t}\sb{1-\frac{d_i}{r_i}}
\ea
$$

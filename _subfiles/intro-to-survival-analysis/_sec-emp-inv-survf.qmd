...
Substituting $\hskmf{t}$ from @def-KM-estimator:
...
Substituting $\hsnaaf{t} = \expf{-\hat{\cuhaz}_{NA}(t)}$
...
- $\hskmf{22} \approx 0.538 > 0.5$
  and $\hskmf{23} \approx 0.448 \le 0.5$,
  so $\hskm^{-1}(0.5) = 23$ months.

- $\hsnaaf{22} \approx 0.557 > 0.5$
  and $\hsnaaf{23} \approx 0.471 \le 0.5$,
  so $\hsnaa^{-1}(0.5) = 23$ months.

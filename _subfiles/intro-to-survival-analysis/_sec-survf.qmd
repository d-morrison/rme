...
Since $\pdf(u) \ge 0$,
the third equality step swaps the order of integration
by Tonelli's theorem
(see the Fubini–Tonelli proof of the
[survival-function mean theorem](probability.qmd#thm-surv-mean)
in the probability chapter for the formal argument):

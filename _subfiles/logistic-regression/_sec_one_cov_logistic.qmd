...
* In [the OC-MI example](binary-outcome-associations.qmd#exm-oc-mi), we estimated the risk and the odds of MI for two groups,
...
{{< include _subfiles/logistic-regression/_sec_logreg_in_R.qmd >}}

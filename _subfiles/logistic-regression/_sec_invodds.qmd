...
Its domain of inputs is $\odds \in [0,\infty)$ and its range of outputs is $\prob \in [0,1]$.
...
\\ &= \frac{\red{1+\odds}}{1 + \odds} - \frac{\teal{\odds}}{1 + \odds}
\\ &= \frac{\red{(1+\odds)} - \teal{\odds}}{1 + \odds}

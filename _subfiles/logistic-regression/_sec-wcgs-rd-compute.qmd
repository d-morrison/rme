...
these helper functions are reused in the bootstrap loop
of @sec-wcgs-rd-bootstrap-ci —
and extract the point estimate already computed in @exm-causal-marginal-rd

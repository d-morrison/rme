...
- The **y-axis** (Standardized Residuals) shows the observed standardized residual $r_i$.
  ...
  (order statistics)
  of the standardized residual distribution
  at the corresponding plotting positions.
  So `qqnorm()` calling the axis "Sample Quantiles"
  and `autoplot.lm()` calling it "Standardized residuals"
  are two names for the same y-values.

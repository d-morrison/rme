...
so that the notation below is equivalent to conditioning on $\mX$:

$$\E{\resid} = 0$$ {#eq-mean-resid-unbiased}
$$\Var{\resid_i} = \ss(1-h_{ii})$$ {#eq-var-resid-leverage}

The mean result (@eq-mean-resid-unbiased)
uses unbiasedness of fitted values.
The variance result (@eq-var-resid-leverage)

...
- The **y-axis** (Standardized Residuals) shows the observed standardized residuals,
  ...
  these ordered values are [sample quantiles](estimation.qmd#def-sample-quantile).
  Let $r_{(1)} \le \cdots \le r_{(n)}$
  be the [order statistics](estimation.qmd#def-order-statistics)
  of the standardized residuals.
  Let $\hat F_r$ be their [empirical CDF](estimation.qmd#def-empirical-cdf)

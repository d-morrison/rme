...
- The **y-axis** (Standardized Residuals) shows the observed standardized residual $r_i$.
  ...
  these values are [sample quantiles](probability.qmd#def-sample-quantile).
  Let $r_{(1)} \le \cdots \le r_{(n)}$ be the [order statistics](probability.qmd#def-order-statistics)

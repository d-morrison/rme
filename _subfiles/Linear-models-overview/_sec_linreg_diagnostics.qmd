...
see [empirical CDF](estimation.qmd#def-empirical-cdf),
[order statistics](probability.qmd#def-order-statistics),
and [sample quantile](probability.qmd#def-sample-quantile)
in the appendices.

...
$$r_i = \frac{\resid_i}{\widehat{SD}(\resid_i)}$$
...
To look for problems with our model, we can check whether the residuals $\resid_i$ and standardized residuals $r_i$ look like they have the distributions that they are supposed to have, according to the model.
...
If our Gaussian linear regression model is correct, the residuals $\resid_i$ and standardized residuals $r_i$ should have:

...
the fitted value $\hat y_i$ is a linear combination of the observations
via the hat matrix $\matr{H} \eqdef \mX\inv{\tp{\mX}\mX}\tp{\mX}$:
...
Since $\hat y_i = \sum_{j=1}^n h_{ij} y_j$,

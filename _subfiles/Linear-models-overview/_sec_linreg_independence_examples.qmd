...
The following simulation (@exm-independence-diagnostics-simulated) generates ordered data with positively autocorrelated errors.
This serial correlation creates a setting where independence should fail.

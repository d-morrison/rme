...
This implies that $\sum_{i=1}^n \vx_i \vx_i'$ is invertible.
To solve for $\vb$,
use $\vx_i (\vx_i \cdot \vb) = (\vx_i \vx_i\')\vb$:

$$
\ba
\paren{\sumin \vx_i \vx_i\'}\vb &= \sumin \vx_i y_i
\\
\vb &= \paren{\sumin \vx_i \vx_i\'}^{-1}\sumin \vx_i y_i
\\
\hvb &= (\mX\'\mX)^{-1}\mX\'\vy
\ea
$$

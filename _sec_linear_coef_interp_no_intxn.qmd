...
$$
\begin{aligned}
\frac{d}{da}\mu(1,a) &= \frac{d}{da}(\beta_0 + \beta_M 1 + \red{\beta_A} a)\\
&= \left(\frac{d}{da}\beta_0 + \frac{d}{da}\beta_M 1 + \frac{d}{da}\red{\beta_A} a\right)\\
&= (0 + 0 + \red{\beta_A}) \\
&= \red{\beta_A}
\end{aligned}
$$
...
$$
\begin{aligned}
\frac{d}{da}\mu(0,a) &= \frac{d}{da}(\beta_0 + \beta_M 0 + \red{\beta_A} a)\\
&= \left(\frac{d}{da}\beta_0 + \frac{d}{da}\beta_M 0 + \frac{d}{da}\red{\beta_A} a\right)\\
&= (0 + 0 + \red{\beta_A}) \\
&= \red{\beta_A}
\end{aligned}
$$

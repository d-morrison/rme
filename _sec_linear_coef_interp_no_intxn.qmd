...
$$
\begin{aligned}
\frac{d}{da}\mu(1,a) &= \frac{d}{da}(\beta_0 + \beta_M \cdot 1 + \red{\beta_A} \cdot a)\\
&= \left(\frac{d}{da}\beta_0 + \frac{d}{da}\beta_M \cdot 1 + \frac{d}{da}(\red{\beta_A} \cdot a)\right)\\
&= (0 + 0 + \red{\beta_A}) \\
&= \red{\beta_A}
\end{aligned}
$$
...
$$
\begin{aligned}
\frac{d}{da}\mu(0,a) &= \frac{d}{da}(\beta_0 + \beta_M \cdot 0 + \red{\beta_A} \cdot a)\\
&= \left(\frac{d}{da}\beta_0 + \frac{d}{da}\beta_M \cdot 0 + \frac{d}{da}(\red{\beta_A} \cdot a)\right)\\
&= (0 + 0 + \red{\beta_A}) \\
&= \red{\beta_A}
\end{aligned}
$$
...
$$
\begin{aligned}
\frac{d}{da}\mu(m,a) &= \frac{d}{da}(\beta_0 + \beta_M \cdot m + \red{\beta_A} \cdot a)\\
&= \left(\frac{d}{da}\beta_0 + \frac{d}{da}\beta_M \cdot m + \frac{d}{da}(\red{\beta_A} \cdot a)\right)\\
&= (0 + 0 + \red{\beta_A}) \\
&= \red{\beta_A}
\end{aligned}
$$

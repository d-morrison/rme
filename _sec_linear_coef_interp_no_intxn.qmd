...
$$
\begin{aligned}
\frac{d}{da}\mu(1,a) &= \frac{d}{da}(\b_0 + \b_M \cdot 1 + \red{\b_A} \cdot a)\\
&= \left(\frac{d}{da}\b_0 + \frac{d}{da}\b_M \cdot 1 + \frac{d}{da}(\red{\b_A} \cdot a)\right)\\
&= (0 + 0 + \red{\b_A}) \\
&= \red{\b_A}
\end{aligned}
$$
...
$$
\begin{aligned}
\frac{d}{da}\mu(0,a) &= \frac{d}{da}(\b_0 + \b_M \cdot 0 + \red{\b_A} \cdot a)\\
&= \left(\frac{d}{da}\b_0 + \frac{d}{da}\b_M \cdot 0 + \frac{d}{da}(\red{\b_A} \cdot a)\right)\\
&= (0 + 0 + \red{\b_A}) \\
&= \red{\b_A}
\end{aligned}
$$
...
$$
\begin{aligned}
\frac{d}{da}\mu(m,a) &= \frac{d}{da}(\b_0 + \b_M \cdot m + \red{\b_A} \cdot a)\\
&= \left(\frac{d}{da}\b_0 + \frac{d}{da}\b_M \cdot m + \frac{d}{da}(\red{\b_A} \cdot a)\right)\\
&= (0 + 0 + \red{\b_A}) \\
&= \red{\b_A}
\end{aligned}
$$

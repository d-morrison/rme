...
{{< include _subfiles/sec/_sec-surv-vars.qmd >}}

# Distribution functions for time-to-event variables

{{< include _subfiles/sec/_sec-surv-dists.qmd >}}

# Parametric Models for Time-to-Event Outcomes

{{< include _subfiles/sec/_sec-surv-intro-parametric-models.qmd >}}

# Nonparametric Survival Analysis

{{< include _subfiles/sec/_sec-surv-nonparametric-surv-intro.qmd >}}

# Example: clinical trial for pediatric acute leukemia

{{< include _subfiles/sec/_sec-surv-6mp.qmd >}}

# The Kaplan-Meier Product Limit Estimator

{{< include _subfiles/sec/_sec-surv-KM.qmd >}}

# Using the `survival` package in R

{{< include _subfiles/sec/_sec-surv-R.qmd >}}

# The log-rank test

{{< include _subfiles/sec/_sec-surv-logrank-test.qmd >}}

# Example: Bone Marrow Transplant Data

{{< include _subfiles/sec/_sec-surv-exm-bmt.qmd >}}

# Nelson-Aalen Estimates of Cumulative Hazard and Survival

{{< include _subfiles/sec/_sec-surv-nelson-aalen.qmd >}}

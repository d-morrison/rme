...
- **Link function**: 
$\logf{\theta(\vx)} = \diffloghaz(\vx)$ or $\logf{\haz(t|\vx)} = \loghaz(t|\vx)$

- **Inverse link function**: $\theta(\vx) = \expf{\diffloghaz(\vx)}$ or $\haz(t|\vx) = \expf{\loghaz(t|\vx)}$

**Linear Predictor Component**: 
$\loghaz(t|\vx) = \loghaz_0(t) + \diffloghaz(t|\vx)$ or 

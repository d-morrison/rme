...
This web-book is derived from my lecture slides for Epidemiology 204:
"Quantitative Epidemiology III: Statistical Models", at UC Davis.

For students working with the UC Davis Seroepidemiology Research Group (SeRG),
please refer to the [lab manual](https://github.com/UCD-SERG/lab-manual) for group-specific information and guidelines.

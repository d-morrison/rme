...
Recall from previous sections that the asymptotic standard error of ${\widehat{\mu}}_{ML}$ is $\HSE{{\widehat{\mu}}} = \sqrt{\sb{\inv{\heinff{{\widehat{\mu}}_{ML}}}}} = \frac{\hat{\sigma}}{\sqrt{n}}$

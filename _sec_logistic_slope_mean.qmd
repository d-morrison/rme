...
By [the derivative of a linear combination](math-prereqs.html#thm-deriv-lincom):
...
By @thm-d_prob-d_logodds, @lem-d_logodds-d_x, and the [chain rule](math-prereqs.html#thm-chain-rule):

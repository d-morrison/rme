...
Compute and graph the likelihood for the `beetles` data.
:::
...
equatiomatic::extract_eq(beetles_glm_grouped_centered)
```
...
score function of `beetles` data (centered model)

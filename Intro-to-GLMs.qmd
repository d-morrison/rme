...
1.   What distribution does the outcome have for a specific sub-population defined by covariates? (**outcome model**)

2.  How does the combination of covariates relate to the mean? (**link function**)

3.   How do the covariates combine? (**linear predictor/linear component**)

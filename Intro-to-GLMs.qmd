...
2.   The **linear component** (aka *linear predictor* or 
*linear functional form*) describing how the covariates combine to define subpopulations:

$$\eta \eqdef \vx \' \vb = \b_0 + \b_1 x_1 + \b_2 x_2 + ...$$

---

3.  The **link function** relating the outcome distribution to the linear component

...
union is $A$.
By property 3 of @def-probability and @thm-law-conditional-prob:
...
- $\Pr(+ \mid \neg D) = 0.01$ (false positive rate, since specificity $= 0.99$)
...
For any function $g$ of a *continuous* random variable $X$:

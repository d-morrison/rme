...
#### Linear combination
For any two vectors $\vx = \x1n$ and $\vy = \v1n$,
the dot-product

$$\vx \cdot \vy = \sumin x_i y_i$$

is called the **linear combination** of $\vx$ and $\vy$.
...
and corresponding vector of constants $\vec{a} = a_1, ... ,a_n$:

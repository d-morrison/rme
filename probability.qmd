...
#### Probability
A probability measure $\Pr()$ is a function 
whose domain is a [$\sigma$-algebra](https://en.wikipedia.org/wiki/%CE%A3-algebra) 
...
3. The probability of the union of disjoint events $A_1, A_2: A_1 \cap A_2 = \emptyset$ is equal to 
...
:::{#thm-prob-subset}
If $A$ and $B$ are statistical events and $A\subseteq B$, then $\Pr(A, B) = \Pr(A)$.
:::

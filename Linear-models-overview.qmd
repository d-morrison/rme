...
$\beta_A$ is the difference in the mean value of birthweight that we would expect, for a one-unit difference in gestational age, adjusting for sex.
...
E[Y|A=a,M=m] = \mu(a,m) = 
\begin{cases} 
\beta_0 + \beta_M m +\beta_A a, & for m\in {0,1} \\ 
\text{undefined, & for m \notin {0,1}
\end{cases}
$$
...
$$
\begin{aligned}
 E[Y|a+1,1] - E[Y|a,1] &= \beta_0 + \beta_M 1 + \beta_A(a+1) + \beta_{AM}1(a+1) - (\beta_0 + \beta_M 1 + \beta_A(a) + \beta_{AM}1(a))\\
 &=  \beta_A + \beta_{AM}\\
...
$$
\begin{aligned}
 E[Y|a+1,0] - E[Y|a,0] &= \beta_0 + \beta_M0 + \beta_A(a+1) + \beta_{AM}0(a+1) - (\beta_0 + \beta_M 0 + \beta_A(a) + \beta_{AM}0(a))\\
...
The below table compares the coefficient interpretations for the parallel lines and interaction models.
  ...
  $\mu(a,s)$    | $\beta_0 + \beta_M m + \beta_A a$ | $\beta_0 + \beta_M m + \beta_A a + \beta_{MA} ma $
----------------|-----------------------------------|---------------------------------------------------
  $\beta_0$     | $ E[Y|a,1] - E[Y|a,0] $           | $ E[Y|A=0,1] - E[Y|A=0,0] $
  $\beta_A$     | $ E[Y|a+1,m] - E[Y|a,m] $         | $ E[Y|a+1,0] - E[Y|a,0] $
  $\beta_M$     | $ E[Y|a,1] - E[Y|a,0] $           | $ E[Y|A=0,1] - E[Y|A=0,0] $
  $\beta_{AM}$  |                                   | $ (E[Y|a+1,1] - E[Y|a,1]) - (E[Y|a+1,0] - E[Y|a,0]) $

...
What is the interpretation of $\beta_A$ in the model?
:::
...
\begin{matrix} 
\beta_0 + \beta_M m +\beta_A a, & \text{for} m\in {0,1} \\ 
\text{undefined}, & \text{for} m \notin {0,1}
\end{matrix}
$$
The model is undefined for $m\neq \{0,1\}$, so the derivative with respect to $m$ doesn't exist.
:::
...
:::{.notes .smaller}
  $\mu(a,s)$    | $\beta_0 + \beta_M m + \beta_A a$ | $\beta_0 + \beta_M m + \beta_A a + \beta_{AM} ma$
----------------|------------------------------------|---------------------------------------------------

...
{{< include _subfiles/sec/_sec_linreg_overview.qmd >}}

# Understanding Gaussian Linear Regression Models {#sec-understand-LMs}

{{< include _subfiles/sec/_sec_linreg_understanding.qmd >}}

# Estimating Linear Models via Maximum Likelihood {#sec-est-LMs}

{{< include _subfiles/sec/_sec_linreg_est.qmd >}}

# Inference about Gaussian Linear Regression Models {#sec-infer-LMs}

{{< include _subfiles/sec/_sec_linreg_inference.qmd >}}

# Prediction {#sec-predict-LMs}

{{< include _subfiles/sec/_sec_linreg_prediction.qmd >}}

# Assessing model fit {#sec-assess-LMs}

{{< include _subfiles/sec/_sec_linreg_assess.qmd >}}

...
:::{#tbl-compare-coef-interps}
  $\mu(s,a)$    | $\beta_0 + \beta_M m + \beta_A a$  | $\beta_0 + \beta_M m + \beta_A a + \red{\beta_{AM} ma}$
----------------|------------------------------------|---------------------------------------------------
  $\beta_0$     | $E[Y\mid 1,a] - E[Y\mid 0,a]$      | $E[Y\mid 1,0] - E[Y\mid 0,0]$
  $\beta_A$     | $\deriv{a}\mu(m,a)$                | $\deriv{a}\mu(0,a)$
  $\beta_M$     | $E[Y\mid 1,a] - E[Y\mid 0,a]$      | $E[Y\mid 1,0] - E[Y\mid 0,0]$

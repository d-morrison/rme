...
$$
\begin{aligned}
E[Y|A = a, M = 1] &= \beta_0 + \red{\beta_M} 1 + \beta_A a \\
& = \beta_0 + \red{\beta_M} + \beta_A a \\
E[Y|A = a, M = 0] &= \beta_0 + \red{\beta_M} 0 + \beta_A a \\
& = \beta_0 + \beta_A a
\end{aligned}
$$
So: 
$$
\begin{aligned}
E[Y|A = a,M = 1] - E[Y|A = a,M = 0] &= (\beta_0 + \red{\beta_M} + \beta_A a) - (\beta_0 + \beta_A a) \\
&= \red{\beta_M}
\end{aligned}
$$
Therefore:
$$ 
\ba
\beta_M &= E[Y|A = a,M = 1] - E[Y|A = a,M = 0]\\
& =\mu(a,1) - \mu(a,0)\\
\ea
$$
...
$$
\ba 
\beta_{M} &= \mu(0,1) - \mu(0,0) \\
&= \E{Y|A = 0,M = 1} - \E{Y|A = 0,M = 0}
\ea
$$ 
...
$$
\ba
\b_{AM} = &\deriv{a}\mu(a,1) - \deriv{a}\mu(a,0)\\
= &(E[Y|A = a+1,M = 1] - E[Y|A = a,M = 1])\\
&- (E[Y|A = a+1,M = 0] - E[Y|A = a,M = 0])
\ea
$$

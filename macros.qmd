...
<!-- see https://www.overleaf.com/learn/latex/Using_colors_in_LaTeX#Named_colors_provided_by_the_xcolor_package -->
...
\providecommand{\maroon}[1]{{\color{maroon}#1}}
...
\providecommand{\indigo}[1]{{\color{indigo}#1}}
...
\providecommand{\Var}[1]{\text{Var}\paren{#1}}
\providecommand{\hVar}[1]{\hat{\text{Var}}\paren{#1}}
\providecommand{\Varf}[1]{\text{Var}\paren{#1}}
\def\Covt{\text{Cov}}

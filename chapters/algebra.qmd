...
$$\inf A \eqdef \max\{t \in \reals: t \le a \text{ for all } a \in A\}$$
...
- $\inf(0.5, 1] = 0.5 = \min[0.5, 1]$:
  ...
  corresponding interval that is closed below, even though $0.5 \notin (0.5, 1]$.
...
$$\sup A \eqdef \min\{t \in \reals: t \ge a \text{ for all } a \in A\}$$
...
{{< include _subfiles/algebra/_exr-double-exponentials.qmd >}}

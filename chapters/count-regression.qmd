...
it assumes only a partial *model structure* --- the mean-variance relationship
...
This approach provides valid standard errors
and $p$-values when overdispersion is multiplicative.
Those standard errors are not sandwich estimates, though,
so their validity rests on the assumed mean-variance relationship holding.

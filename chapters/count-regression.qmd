...
We can still model expected count $\mu(\vx, t)$ as a function of covariate vector $\vX = \vx$ and exposure magnitude $T = t$ as before,
...
it specifies only the mean-variance relationship $\Var{Y \mid \vX=\vx} = \mu\theta$,

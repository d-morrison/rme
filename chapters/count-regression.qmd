...
but it imposes no functional form linking the variance to the mean:
it estimates the variance at each covariate pattern from the data,
rather than assuming the variance is $\theta$ times the mean.
That is what lets it remain reliable

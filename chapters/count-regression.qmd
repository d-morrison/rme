...
It buys that validity from the assumed mean-variance relationship
rather than from a sandwich estimator,
so unlike a sandwich estimator it gives nothing back
when that relationship is wrong.

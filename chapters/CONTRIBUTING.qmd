...
The [GitHub repository for this project](https://github.com/Morrison-Lab/rme)
...
*   Fork the package and clone onto your computer. If you haven't done this before, we recommend using `usethis::create_from_github("Morrison-Lab/rme", fork = TRUE)`.

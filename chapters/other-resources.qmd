...
His presentation [Tips for Biostatisticians Collaborating with Non-Biostatistician Medical Researchers](https://hbiostat.org/talks/collab.html#1) offers valuable guidance on statistical collaboration ("Your job is not to give the investigator what she wants; Your job is to give her what she needs").
...
provides clear, step-by-step video tutorials
on core statistical and machine learning concepts,
including linear models and logistic regression.

- [AmstatVideos (American Statistical Association YouTube Channel)](https://www.youtube.com/@AmstatVideos)
features lectures, webinars, and historical interviews with prominent statisticians,

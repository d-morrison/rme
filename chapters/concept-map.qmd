...
re-titled** to refresh the diagram and @tbl-descendants.
...
@tbl-descendants gives each result's full name.
...
# Abbreviate long node labels for the diagram only (the descendants table
...
[HTML version of the notes](https://morrison-lab.github.io/rme/chapters/concept-map.html).

...
- Kyoungmi Kim's and Susan Stewart's materials from the 2022 edition of this course
...
- Ron Brookmeyer's materials from the Winter 2017 edition of Biostat 100B at UCLA

- Weng Kee Wong's materials from the Spring 2017 edition of Biostat 200C at UCLA

- Jonathan Taylor's materials from Stat 191 at Stanford University
(see <https://web.stanford.edu/class/stats191> for the current version)
...
Please see also the list of contributors on GitHub: <https://github.com/Morrison-Lab/rme/graphs/contributors>
...
The notes are available online at <https://morrison-lab.github.io/rme/> and are searchable and continuously updated^[see the source file repository for recent changes: <https://github.com/Morrison-Lab/rme>].
...
2. Clone the project repository from [GitHub](https://github.com/Morrison-Lab/rme),

...
The Fubini–Tonelli theorem (@thm-fubini, stated in the math-prereqs
chapter) gives conditions under which a double integral can be
evaluated as an iterated integral and the order of integration can be
exchanged.
It specializes nicely to expectations against probability measures,
where the σ-finiteness hypothesis is automatic
...
the general form of @thm-fubini applies and gives both iterated forms.
...
::: proof
Apply the Lebesgue case of @thm-fubini to the integrand
$h(x,y)\,f_{X,Y}(x,y)$.
If the joint density's support is not a rectangle, extend
$f_{X,Y}$ by zero outside its support to the enclosing rectangle, as in
the non-rectangular subcase of @thm-fubini.

...
be measurable.
Here $\rangef{X}$ and $\rangef{Y}$
denote the ranges of $X$ and $Y$.
If either
...
$\P_X \otimes \P_Y$,
and by definition of expectation with respect to the joint distribution,
$\E{h(X, Y)} = \int h(x, y)\,d(\P_X \otimes \P_Y)$,

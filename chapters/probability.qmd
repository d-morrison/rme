...
yields the corollaries below directly.

{{< slidebreak >}}

:::{#cor-fubini-prob}

### Probability-measure form (independent variables; corollary of Fubini–Tonelli)
...
so the σ-finiteness hypothesis of
[Fubini–Tonelli](math-prereqs.qmd#thm-fubini-tonelli) is automatic;
...
### Joint-density form (without independence; corollary of Fubini–Tonelli)
...
[Fubini–Tonelli](math-prereqs.qmd#thm-fubini-tonelli) to the integrand $h(x,y)\,f_{X,Y}(x,y)$ on
$\rangef{X} \times \rangef{Y}$.
...
[Fubini–Tonelli](math-prereqs.qmd#thm-fubini-tonelli) then expresses it as either iterated form above.
...
### Fubini–Tonelli proof of the survival-function mean theorem (continuous case) {#sec-fubini-proof-surv-mean}

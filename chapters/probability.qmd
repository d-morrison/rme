...
Let $f(x, y)$ be a jointly measurable function on $\mathbb{R}^2$.
If $f(x, y) \ge 0$ for all $(x, y)$,
or if $\iint_{\mathbb{R}^2} |f(x, y)|\,dy\,dx < \infty$,
then the order of integration may be swapped:
...
[@gut2013, Theorem 9.1; @fubini1907; @wp:fubini]

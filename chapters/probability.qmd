...
When $\alpha=1$, the Weibull distribution reduces to the exponential distribution. When $\alpha>1$ the hazard is
increasing and when $\alpha < 1$ the hazard is decreasing. This property provides

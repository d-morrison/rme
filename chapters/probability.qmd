...
::: proof
Apply @thm-fubini-tonelli (with $\mu_1 = \mu_2 = $ Lebesgue measure)
to the integrand $h(x,y)\,f_{X,Y}(x,y)$ on
$\rangef{X} \times \rangef{Y}$;
...
zero outside its support to the enclosing simple region;
@thm-fubini-tonelli then expresses the integral as either iterated
form above.
...
### Survival-function mean (corollary of @thm-fubini-tonelli)
...
exchange the order of integration over the unbounded triangular

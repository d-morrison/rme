...
format:
  ...
  docx:
    output-file: intro-to-R-handout.docx

---

# Online R learning resources

There are an overwhelming number of great resources for learning R;
...
- [ENV 224](https://catalog.ucdavis.edu/search/?q=ENV+224)/
  ...
  Data Management & Visualization in R
     - see lecture videos and course materials at 
       <https://ucd-rdavis.github.io/R-DAVIS/index.html>
...
- [PSC 120](https://catalog.ucdavis.edu/search/?q=PSC+120):
...
There are currently (2026) two commonly-used pipe operators in R:
...
To compile Quarto documents to PDF, you need a LaTeX installation.
[TinyTeX](https://yihui.org/tinytex/) is a lightweight, portable LaTeX distribution
recommended for use with Quarto.
...
**Alternative method** (run from the R console):
...
- Video tutorial:
  [Preparing RStudio to Generate PDF Files with Quarto and TinyTeX](https://www.youtube.com/watch?v=OUWOx80eJqk)
...
Over time, explore all the tabs and menus;
there are a lot of great quality-of-life features.

* use the `History` tab to view past commands;
you can rerun them or copy them into a source code file in one click! (up-arrow in the Console also enables this process, but less easily).

...
{{< include _subfiles/predictor-selection/_sec-pred-sel-overview.qmd >}}

# Inferential Goals {#sec-pred-sel-goals-chapter}

{{< include _subfiles/predictor-selection/_sec-pred-sel-goals.qmd >}}

# Causal Thinking and DAGs {#sec-pred-sel-causal}

DAG material for this course is covered in the
[causal inference chapter](causal-inference.qmd#sec-pred-sel-dag).

For the worked examples,
see:

- [The HERS DAG example](causal-inference.qmd#sec-pred-sel-hers-dag)
- [The WCGS DAG example](causal-inference.qmd#sec-pred-sel-wcgs-dag)
...
{{< include _subfiles/predictor-selection/_sec-pred-sel-prediction.qmd >}}

# Evaluating a Predictor of Primary Interest {#sec-pred-sel-eval}

{{< include _subfiles/predictor-selection/_sec-pred-sel-primary.qmd >}}

# Identifying Multiple Important Predictors {#sec-pred-sel-multiple-chapter}

{{< include _subfiles/predictor-selection/_sec-pred-sel-multiple.qmd >}}
...
in [the HERS DAG](causal-inference.qmd#fig-hers-dag).

:::

# Some Details {#sec-pred-sel-details}

{{< include _subfiles/predictor-selection/_sec-pred-sel-details.qmd >}}

...
::: notes
To check whether stratification changed the influence picture,
re-examine the subjects flagged earlier from the `hodg_cox2` diagnostics
(1, 15, 16, 18, and 29):
scan each panel for points that stand apart from the rest,
since those are the observations whose removal would most shift the
corresponding coefficient.
The deviance residuals above and these dfbeta panels together indicate
whether any single subject still exerts outsized influence on
`hodg_cox3`.
:::

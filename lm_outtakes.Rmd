...
$\mathcal l(x|\theta) = \log \mathcal L(x|\theta)$
...
For individuals with the same covariates, outcome has a Gaussian distribution

$$p(y | x) = (2\pi\sigma^2)^{-1/2} \exp\left\{\frac{1}{2} \left(\frac{y-\mu(x)}{\sigma}\right)^2\right\}$$
